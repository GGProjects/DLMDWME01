...
Vorhersagezeitraum etwa 2 Monate Datenzeitraum etwa drei Jahre (36 Monate) Übliche Aufsplittung 80:20 aber zumindest den Vorhersagezeitraum (ca. 29 Monate:7 Monate) Vorhersagezeitraum gegeben. Starker Aufwärtstrend von Anfang 2019 soll im Training aber noch mitgenommen werden, daher reduktion des Testdatensatzes auf 4 Monate (ab 2019-02-01)
...
ts_sby_train <- ts_sby %>%
  select(date, calls, MA2_8, diff_nduty, sby_need) %>%
  filter(date < "2019-02-01", !is.na(MA2_8))
...
Lineare Korrelation auch im Trainingsdatensatz noch etwa gleich gegeben.
